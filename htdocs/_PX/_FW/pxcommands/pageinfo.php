...
class px_pxcommands_pageinfo extends px_bases_pxcommand{
	...
	private function execute(){
		...
		$src = '';
		$src .= '<script type="text/javascript">'.$this->jq_qrcode().'</script>'."\n";
		$src .= '<div class="unit">'."\n";
		...
		ob_start(); ?>
<div class="cont_qr_code" style="padding:20px;"></div>
<script type="text/javascript">
$(function(){
	$('.cont_qr_code').qrcode({"width":240, "height":240, "text": <?php print t::data2jssrc($this->mk_current_url()); ?>});
});
</script>
<?php
		$src .= ob_get_clean();
